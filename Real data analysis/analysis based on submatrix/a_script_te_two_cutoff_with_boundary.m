...
num_frames=500;
resize_param=0.1;
lambda_data1=1:5:56;             %%lambda_data1=1:3:70;
lambda_data2=1:5:56;             %%lambda_data2=1:3:70;
...
save(['data_te_two_cutoff/te_with_boundary_frame_',num2str(frame_ind),'.mat'],'trans_ent')