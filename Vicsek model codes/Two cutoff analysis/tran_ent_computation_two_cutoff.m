...
function tran_ent_computation_two_cutoff(d,tau,lbox,ncell,num_trail,noise_array,nsymbols,num_lambda,max_lambda)
    ...
    for cell1=1:ncell
        for cell2=1:ncell
            ...
            if (cell1<cell2)
                ...
                save(['data_te/te_cell_',num2str(cell1),'_',num2str(cell2),'_noise_',num2str(noise_ind),'.mat'],'tran_ent')
            end
