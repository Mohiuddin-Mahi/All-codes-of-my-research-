...
title(['Expected(TE_x_y)',' , ','R=',num2str(R),' , ','\lambda_2 \leq d \leq \lambda_1'])
view(2)
colorbar
colormap(jet)
grid off
...
ylim([0 2*R])
set(gca, 'YDir','reverse')
title(['|\nabla(TE_x_y)|',' , ','R=',num2str(R),' , ','\lambda_2 \leq d \leq \lambda_1'])
view(2)
colorbar
colormap(jet)
grid off
...
ylim([0 2*R])
set(gca, 'YDir','reverse')
title(['|\nabla^2(TE_x_y)|',' , ','R=',num2str(R),' , ','\lambda_2 \leq d \leq \lambda_1'])
view(2)
colorbar
colormap(jet)
grid off
