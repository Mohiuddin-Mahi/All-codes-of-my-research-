...
for frame1=500
    ...
    for lambda_ind1=1:length(lambda_array1)
        ...
        parfor lambda_ind2=1:length(lambda_array2)
            ...
            if lambda1>lambda2
                ...
                data_x=load(['grid_intensity_data/grid_intensity_data_',num2str(frame1,'%.3d'),'.mat']);
                ...
                for frame_ind2=1:length(frame2_num)
                    ...
                    data_y=load(['grid_intensity_data/grid_intensity_data_',num2str(frame2,'%.3d'),'.mat']);
    ...
    save(['data_stat_test/stat_test_lstep_',num2str(lstep),'_frame_',num2str(frame1),'_',...
        num2str(frame1+tau),'_surframe_960_979.mat'],'true_te','surrogate_te','true_prob',...
