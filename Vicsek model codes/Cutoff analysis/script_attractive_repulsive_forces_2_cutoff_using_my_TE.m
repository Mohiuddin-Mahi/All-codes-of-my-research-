...
%%%% Mohiuddin:Computation of the binary model for attaractive and repulsive forces using my TE function %%%%%
    ...
    for l_ind2=1:length(lambda2)
        ...
        parfor trail_ind=1:num_trails
            if cutoff1>cutoff2
                ...
                data(delete_ind,:)=[];
                data1=data;   
                transfer_entropy(l_ind1,l_ind2,trail_ind)= transfer_ent_function(data1,symbols);                
            else
