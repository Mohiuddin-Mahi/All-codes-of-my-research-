...
for frame_ind1=500:505  

    load(['grid_intensity_data/grid_intensity_data_',num2str(frame_ind1,'%.4d'),'.mat'])
    data1= imresize(double(lambda_grid_intensity{row_ind,col_ind}),resize_param)>0;                  %% x_data
    load(['grid_intensity_data/grid_intensity_data_',num2str(frame_ind1+tau,'%.4d'),'.mat'])
