...
function tran_ent_computation_two_cutoff_resample(d,tau,lbox,ncell,num_trail,noise_array,nsymbols,num_lambda,max_lambda)
...
for noise_ind=1:length(noise_array)
    ...
    data=load(['symbols_resample/symbols_noise_',num2str(noise_ind),'.mat']);
    ...
    for cell1=1:ncell
        for cell2=1:ncell
            ...
            if (cell1<cell2)
                ...
                save(['data_te_resample/te_cell_',num2str(cell1),'_',num2str(cell2),'_noise_',num2str(noise_ind),'.mat'],'tran_ent')
            end
