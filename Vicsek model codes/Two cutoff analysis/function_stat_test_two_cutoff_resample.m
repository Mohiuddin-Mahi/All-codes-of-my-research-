...
function function_stat_test_two_cutoff_resample(d,tau,lbox,ncell,num_trail,noise_array,nsymbols,num_lambda,...
    max_lambda,alpha)
    ...
    for cell1=1:ncell
        for cell2=1:ncell
            ...
            if (cell1<cell2)
                ...
                save(['data_te_resample/stat_test_cell_',num2str(cell1),'_',num2str(cell2),'_noise_',num2str(noise_ind)],...
